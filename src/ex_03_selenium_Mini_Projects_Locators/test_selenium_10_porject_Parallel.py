...
# 5. **Find and Enter **the details **Username : Zara and Password: password** and **Click** on the Login Button
# 6. Verify error message - Login failed! Please ensure the username and password are valid.
